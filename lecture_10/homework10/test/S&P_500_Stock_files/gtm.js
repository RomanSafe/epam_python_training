...
"resource": {
  ...
  "macros":[{
      ...
      "vtp_javascript":["template","(function(){var a=",["escape",["macro",10],8,16],".substr(",["escape",["macro",10],8,16],".lastIndexOf(\"\/\")+1);return a?a:\"marketsinsider\"})();"]
    },{
      "function":"__c",
  ...
  "tags":[{
      ...
      "vtp_enableLinkId":false,
      "vtp_dimension":["list",["map","index","1","dimension","MarketsInsider"],["map","index","4","dimension",["macro",4]],["map","index","11","dimension",["macro",5]]],
      "vtp_enableEcommerce":false,
      ...
      "vtp_eventLabel":["template",["macro",13]," - line ",["macro",14]],
      "vtp_trackingId":"UA-42100436-1",
      "vtp_enableRecaptchaOption":false,
      "vtp_enableUaRlsa":false,
      "vtp_enableUseInternalVersion":false,
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003Efor(var selectedItems=document.querySelectorAll(\"div[data-room\\x3dRY0306000000WTI]\"),i=0;i\u003CselectedItems.length;i++)selectedItems[i].setAttribute(\"data-room\",\"CRAP\"),selectedItems[i].setAttribute(\"data-item\",\"CRAP\");\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":149
      ...
      "consent":["list"],
      "once_per_event":true,
      "vtp_html":"\n\u003Cscript type=\"text\/gtmscript\"\u003Efunction CheckCountry(a){\"US\"!==a\u0026\u0026\"CA\"!==a\u0026\u0026(a=document.getElementById(\"plus-500-trading-button\"))\u0026\u0026a.classList.remove(\"hidden\")}var usrLoc=JSON.parse(localStorage.getItem(\"miusrLocObj\"));usrLoc?CheckCountry(usrLoc.country_code):$.get(\"https:\/\/geoip.finanzen.net\/json\/\",function(a){a\u0026\u0026(localStorage.setItem(\"miusrLocObj\",JSON.stringify(a)),CheckCountry(a.country_code))});\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":155
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript data-gtmsrc=\"https:\/\/maps.googleapis.com\/maps\/api\/js?key=AIzaSyC6QM-meB_M4zi-C6hrxD70bKFanv1snoc\" type=\"text\/gtmscript\"\u003E\u003C\/script\u003E\n\u003Cscript type=\"text\/gtmscript\" data-gtmsrc=\"https:\/\/www.google.com\/jsapi?key=AIzaSyC6QM-meB_M4zi-C6hrxD70bKFanv1snoc\"\u003E\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":157
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003Efunction CheckCountryEU(b){-1\u003Cb.indexOf(\"Europe\")\u0026\u0026runGdpr()}\nfunction runGdpr(){!function(){var m=function(){for(var k,h=\"__tcfapiLocator\",l=[],d=window;d;){try{if(d.frames[h]){k=d;break}}catch(p){}if(d===window.top)break;d=d.parent}k||(!function e(){var f=d.document,a=!!d.frames[h];if(!a)if(f.body){var c=f.createElement(\"iframe\");c.style.cssText=\"display:none\";c.name=h;f.body.appendChild(c)}else setTimeout(e,5);return!a}(),d.__tcfapi=function(){for(var e,f=arguments.length,a=Array(f),c=0;c\u003Cf;c++)a[c]=arguments[c];if(!a.length)return l;\"setGdprApplies\"===a[0]?\n3\u003Ca.length\u0026\u00262===parseInt(a[1],10)\u0026\u0026\"boolean\"==typeof a[3]\u0026\u0026\"function\"==typeof a[2]\u0026\u0026a[2](\"set\",!0):\"ping\"===a[0]?(e={gdprApplies:e,cmpLoaded:!1,cmpStatus:\"stub\"},\"function\"==typeof a[2]\u0026\u0026a[2](e)):l.push(a)},d.addEventListener(\"message\",function(e){var f=\"string\"==typeof e.data,a={};try{a=f?JSON.parse(e.data):e.data}catch(g){}var c=a.__tcfapiCall;c\u0026\u0026window.__tcfapi(c.command,c.version,function(g,n){g={__tcfapiReturn:{returnValue:g,success:n,callId:c.callId}};f\u0026\u0026(g=JSON.stringify(g));e.source.postMessage(g,\n\"*\")},c.parameter)},!1))};\"undefined\"!=typeof module?module.exports=m:m()}();window._sp_={config:{accountId:1108,baseEndpoint:\"https:\/\/cdn.privacy-mgmt.com\"}};var b=document.createElement(\"script\");b.type=\"text\/javascript\";b.readyState\u0026\u0026(b.onreadystatechange=function(){if(\"loaded\"==b.readyState||\"complete\"==b.readyState)b.onreadystatechange=null});b.src=\"https:\/\/cdn.privacy-mgmt.com\/wrapperMessagingWithoutDetection.js\";document.head.appendChild(b)}var usrLoc=JSON.parse(localStorage.getItem(\"miusrLocObj\"));\nusrLoc?CheckCountryEU(usrLoc.time_zone):$.get(\"https:\/\/geoip.finanzen.net\/json\/\",function(b){b\u0026\u0026(localStorage.setItem(\"miusrLocObj\",JSON.stringify(b)),CheckCountryEU(b.time_zone))});\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":160
  ...
  "rules":[
    [["if",0],["add",0,1,2,3,18,20,22,31,32,33,42,44,48,29]],
    [["if",2,3],["add",4,8]],
    [["if",3,4],["add",4,9,35,47]],
    [["if",6,7],["add",5,6,41,47]],
    [["if",7,9],["add",7,15]],
    [["if",3,10],["unless",6],["add",10,17,36,47]],
    [["if",3,11],["add",11,16,37,38,47,51]],
    [["if",3,12],["add",12]],
    [["if",3,13],["add",13,39]],
    [["if",3,14],["add",14,40]],
    [["if",16],["add",19]],
...
"set",t);f(h+"require",b.vtp_optimizeContainerId,{dataLayer:"dataLayer"});f(b.vtp_gtmOnSuccess);f(h+"require","render");a||(a=!0,N(p,function(){return Sh().loaded||b.vtp_gtmOnFailure()},b.vtp_gtmOnFailure));var u=V("dataLayer"),v=u&&u.hide;v&&(v.end||!0===v["GTM-MBTPXX"])&&(v[b.vtp_optimizeContainerId]=!0)}else I(b.vtp_gtmOnFailure)})}();
...
Z.a.csm=["nonGoogleScripts"],function(){(function(a){Z.__csm=a;Z.__csm.b="csm";Z.__csm.g=!0;Z.__csm.priorityOverride=0})(function(a){var b=V("document");pn(function(d){if(2048<d.length){var e=d.substring(0,2040).lastIndexOf("&");d=d.substring(0,e)+"&ns_cut="+Y(d.substring(e+1));d=d.substring(0,2048)}return d}(function(d,e){var f=wm(),h=(e||"").split("&");e="";for(var k=0;k<h.length;k++)if(h[k]){var l=h[k].match(/([^=]*)=?(.*)/);e+="&"+Y(l[1])+"="+Y(l[2])}return Xg("https://sb","http://b",".scorecardresearch.com/b?c1=2&c2="+
Y(d)+"&ns__t="+f.valueOf()+"&ns_c="+(b.characterSet||b.yi||"")+"&c8="+Y(b.title||"")+e+"&c7="+Y(b.URL)+"&c9="+Y(b.referrer))}(a.vtp_clientId,function(){var d="",e=b.cookie;if(0<=e.indexOf("comScore"))for(var f=e.split(";"),h=0;h<f.length;h++){var k=f[h].indexOf("comScore");0<=k&&(d=unescape(f[h].substring(k+8)))}return d}())));var c=function(){var d=Xg("https://sb","http://b",".scorecardresearch.com/c2/"+Y(a.vtp_clientId)+"/cs.js");N(d,a.vtp_gtmOnSuccess,a.vtp_gtmOnFailure)};"complete"===b.readyState?
c():nd(V("self"),"load",c)})}();var Wp={};Wp.macro=function(a){if(Ul.dd.hasOwnProperty(a))return Ul.dd[a]},Wp.onHtmlSuccess=Ul.Ye(!0),Wp.onHtmlFailure=Ul.Ye(!1);Wp.dataLayer=Ze;Wp.callback=function(a){Qe.hasOwnProperty(a)&&Aa(Qe[a])&&Qe[a]();delete Qe[a]};Wp.bootstrap=0;Wp._spx=!1;function Xp(){L[Fe.B]=Wp;Ua(Re,Z.a);Sb=Sb||Ul;Tb=gc}
